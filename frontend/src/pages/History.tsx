  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-white">스캔 기록</h1>
        {history.length > 0 && (
          <button
            onClick={handleClear}
      ...
      {stats && stats.totalScans > 0 && (
        <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
          <h2 className="text-sm font-medium text-slate-400 mb-3">통계</h2>
          <div className="grid grid-cols-3 gap-4 text-center mb-4">
            ...
            <div>
              <p className="text-2xl font-bold text-white">{stats.weekScans}</p>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs">
              <span className="text-green-400">{stats.safePercent}% 안전</span>
              <span className="text-yellow-400">{stats.warningPercent}% 주의</span>
              <span className="text-red-400">{stats.dangerPercent}% 위험</span>
            </div>
          </div>
        </div>
      )}
      ...
      {history.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-slate-400">스캔 기록이 없습니다</p>
